...
import roleplayinggame.controllers.Listeners;
...
public final class Frame extends JFrame {
    ...
    public Frame() throws Exception {
        ...
        listen = new Listeners(this, this.model, this.player);
    ...
    private JMenuBar createJMenuBar() {
        ...
        create.addActionListener(listen.createActionListener);
        gameMenu.add(create);

        JMenuItem save = new JMenuItem("Save Hero");
        save.addActionListener(listen.saveActionListener);
        gameMenu.add(save);

        JMenuItem load = new JMenuItem("Load Hero");
        load.addActionListener(listen.loadActionListener);
        gameMenu.add(load);

        JMenuItem mute = new JMenuItem("Stop/start music");
        mute.addActionListener(listen.muteActionListener);
        gameMenu.add(mute);

        JMenuItem exit = new JMenuItem("Exit game");
        exit.addActionListener(listen.exitActionListener);
        gameMenu.add(exit);

        JButton rest = new JButton("Rest");
        rest.addActionListener(listen.restActionListener);
        jMenuBar.add(rest);

        JButton fight = new JButton("Fight");
        jMenuBar.add(fight);
        fight.addActionListener(listen.fightActionListener);

        JButton help = new JButton("Help");
        jMenuBar.add(help);
        help.addActionListener(listen.helpActionListener);
