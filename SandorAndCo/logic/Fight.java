...
public class Fight {
	...
	/**
     * Constructor: Creates the fight object.
     * @param player: the user's character who fights
	 * @param enemy: the opponent of the player
	 * @param model: controller object of the characters
	 * @param frame: visualize the fight actions
     */
	...
	/**
     * @return If the enemy character is dead returns true, anyway false.
     */
	...
	/**
     *
     * @return If the next one is the player returns true, else false.
     */
	...
	/**
     *Simulates the fight between the player and the enemy characters
     *comment's language: hungarian
	 *Todo: features
     */
    ...
    public void createEnemy() {
        ...
        if (player.getLevel() == 1) {
            enemy.setLevel(rnd.throwDice(2) + 1);
        } else {
            enemy.setLevel(rnd.throwDice(3) + player.getLevel() - 1);
        }

        enemy.setRaging(false);
        enemy.setStatus("Calm");
        enemy.setStrength(rnd.throwDice(3) + 1);
        enemy.setDexterity(rnd.throwDice(3) + 1);
        enemy.setConstitution(rnd.throwDice(3) + 1);
        ...
        enemy.setPictureID(rnd.throwDice(6));
    }
}
