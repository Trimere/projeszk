...
public class Fight {
    ...
    public void createEnemy() {
        ...
        if (player.getLevel() == 1) {
            enemy.setLevel(rnd.throwDice(2));
        } else {
            enemy.setLevel(rnd.throwDice(3) + player.getLevel() - 2);
        }

        enemy.setRaging(false);
        enemy.setStatus("Calm");
        enemy.setStrength(rnd.throwDice(3));
        enemy.setDexterity(rnd.throwDice(3));
        enemy.setConstitution(rnd.throwDice(3));
        ...
        enemy.setPictureID(rnd.throwDice(6)-1);
    }
}
